...
class Inflectible
{
    ...
    {
        (yield new Transformation(new Pattern('(s)tatuses$'), 'CBXWPBookmarkScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(s)tatus$'), 'CBXWPBookmarkScoped\\1\\2tatus'));
        (yield new Transformation(new Pattern('(c)ampus$'), 'CBXWPBookmarkScoped\\1\\2ampus'));
        (yield new Transformation(new Pattern('^(.*)(menu)s$'), 'CBXWPBookmarkScoped\\1\\2'));
        ...
        (yield new Transformation(new Pattern('(m)ovies$'), 'CBXWPBookmarkScoped\\1\\2ovie'));
        (yield new Transformation(new Pattern('(s)eries$'), 'CBXWPBookmarkScoped\\1\\2eries'));
        ...
        (yield new Transformation(new Pattern('(analy|diagno|^ba|(p)arenthe|(p)rogno|(s)ynop|(t)he)ses$'), 'CBXWPBookmarkScoped\\1\\2sis'));
        ...
        (yield new Transformation(new Pattern('(p)eople$'), 'CBXWPBookmarkScoped\\1\\2erson'));
        (yield new Transformation(new Pattern('(m)en$'), '\\1an'));
        (yield new Transformation(new Pattern('(c)hildren$'), 'CBXWPBookmarkScoped\\1\\2hild'));
        (yield new Transformation(new Pattern('(f)eet$'), '\\1oot'));
        (yield new Transformation(new Pattern('(n)ews$'), 'CBXWPBookmarkScoped\\1\\2ews'));
    ...
    {
        (yield new Transformation(new Pattern('(s)tatus$'), 'CBXWPBookmarkScoped\\1\\2tatuses'));
        (yield new Transformation(new Pattern('(quiz)$'), '\\1zes'));
        (yield new Transformation(new Pattern('^(ox)$'), 'CBXWPBookmarkScoped\\1\\2en'));
        ...
        (yield new Transformation(new Pattern('(?:([^f])fe|([lr])f)$'), 'CBXWPBookmarkScoped\\1\\2ves'));
        ...
        (yield new Transformation(new Pattern('(buffal|her|potat|tomat|volcan)o$'), 'CBXWPBookmarkScoped\\1\\2oes'));
