...
class CBXWPBookmarkSettings
{
        ...
        foreach ($options as $option_slug => $option_value) {
            ...
            switch ($field_type) {
                ...
                case 'radio':
                    ...
                    break;
                case 'textarea':
                    $options[$option_slug] = sanitize_textarea_field($option_value);
                    break;
    ...
    {
        $plus_svg  = cbxwpbookmark_esc_svg(cbxwpbookmarks_load_svg('icon_plus'));
        $minus_svg = cbxwpbookmark_esc_svg(cbxwpbookmarks_load_svg('icon_minus'));
     ...
     * @param $value
     */
    function callback_email($args, $value = null)
    {
        if ($value === null) {
            $value = esc_attr($this->get_option($args['id'], $args['section'], $args['default']));
        }
    ...
    function callback_multicheck($args, $value = null)
    {
        ...
        $options_arr = $args['options'];//this can be regular array or associative array


        if ( ! \CBXWPBookmarkHelper::is_associative_array($options_arr)) {
            $options = \CBXWPBookmarkHelper::convert_to_associative_array($options_arr);
        } else {
            $options = $options_arr;
        }
     ...
     * @return void
     */
    function callback_page($args, $value = null)
    {
        if ($value === null) {
            $value = $this->get_option($args['id'], $args['section'], $args['default']);
        }
...
}//end clas CBXWPBookmarkSettings