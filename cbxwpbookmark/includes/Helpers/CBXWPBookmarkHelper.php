...
class CBXWPBookmarkHelper {
    ...
    public static function cbxwpbookmark_setting_fields() {
        ...
        if ( $my_bookmark_page_id > 0 ) {
            ...
            $my_bookmark_page_id_link_html .= sprintf( wp_kses( __( 'Visit <a class="button" href="%s" target="_blank">My Bookmarks</a> Page', 'cbxwpbookmark' ), [
                    'a' => [
                            'href'   => [],
                            'target' => [],
                            'class' => [],
        ...
        if ( $my_bookmark_page_id > 0 ) {
            ...
            $mybookmark_customizer_url_html = '<a class="button" href="' . esc_url( $mybookmark_customizer_url ) . '">' . esc_html__( 'Configure using customizer', 'cbxwpbookmark' ) . '</a>';
        } else {
                ...
                [
                        'cbxwpbookmark_basics' => [
                                ...
                                'hide_for_guest'        => [
                                        ...
                                        'desc'              => esc_html__( 'Totally hide bookmark button for guest user.', 'cbxwpbookmark' ),
                                        'type'              => 'radio',
                                        'default'           => 0,
                                        'options'           => [
                                                1 => esc_html__( 'Yes', 'cbxwpbookmark' ),
                                ...
                                'bookmark_open_newtab'  => [
                                        'name'              => 'bookmark_open_newtab',
                                        'label'             => esc_html__( 'Bookmark Click Action', 'cbxwpbookmark' ),
                                        'desc'              => esc_html__( 'On click bookmark open in new tab or not.', 'cbxwpbookmark' ),
                                        'type'              => 'radio',
                                        'default'           => 0,
                                        'options'           => [
                                                1 => esc_html__( 'Yes', 'cbxwpbookmark' ),
